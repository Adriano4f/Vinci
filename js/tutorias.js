...
(() => {
    ...
    if ("IntersectionObserver" in window) {
        ...
        const bar = $("#prog-bar");
        if (bar) {
            io.observe((_a = bar.parentElement) !== null && _a !== void 0 ? _a : bar);
        }
    }
    else {
    ...
    const progCard = (_b = $("#prog-bar")) === null || _b === void 0 ? void 0 : _b.closest(".nx-card");
    if (progCard && "IntersectionObserver" in window) {
        ...
        const pct = $("#prog-pct");
        if (bar)
            bar.style.width = `${(_c = bar.dataset.w) !== null && _c !== void 0 ? _c : 0}%`;
        if (pct)
            pct.textContent = `${(_d = bar === null || bar === void 0 ? void 0 : bar.dataset.w) !== null && _d !== void 0 ? _d : 0}%`;
    }
    // --- 5. Modal helper ------------------------------------------------------------
    ...
    (_e = $("#nx-modal-close")) === null || _e === void 0 ? void 0 : _e.addEventListener("click", closeModal);
    ...
    (_f = $("#nx-levels")) === null || _f === void 0 ? void 0 : _f.addEventListener("click", (e) => {
        var _a;
    ...
    (_g = $("#bk-again")) === null || _g === void 0 ? void 0 : _g.addEventListener("click", () => {
        var _a;
    ...
    (_h = $("#quiz-opts")) === null || _h === void 0 ? void 0 : _h.addEventListener("click", (e) => {
        var _a;
        ...
        setTimeout(() => {
            ...
            if (quizIdx < QUIZ.length) {
                showQ();
                delete document.getElementById("quiz-opts").dataset.done;
            }
            else {
    ...
    (_j = $("#quiz-begin")) === null || _j === void 0 ? void 0 : _j.addEventListener("click", () => {
        if (quizStart)
    ...
    (_k = $("#gen-new")) === null || _k === void 0 ? void 0 : _k.addEventListener("click", genNew);
    (_l = $("#gen-again")) === null || _l === void 0 ? void 0 : _l.addEventListener("click", genNew);
    (_m = $("#gen-hint")) === null || _m === void 0 ? void 0 : _m.addEventListener("click", () => { const h = $("#gen-hint-out"); if (h)
        h.hidden = false; });
    (_o = $("#gen-sol")) === null || _o === void 0 ? void 0 : _o.addEventListener("click", () => { const s = $("#gen-sol-out"); if (s)
        s.hidden = false; });
